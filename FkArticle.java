...
class FormArticle{
    ...
    private  String[] feihua = new String[]{
    ...
    private String[] Famous = new String[]{
    ...
    private String[] behind = new String[]{
            "这不禁令我深思. ",
    ...
    public FormArticle(String theme) {
        this.theme = theme;
    }

    public String SomeFamous(){
        Random rd = new Random();
        String ms = Famous[rd.nextInt(Famous.length)];
        String fs = font[rd.nextInt(font.length)];
        String bs = behind[rd.nextInt(behind.length)];
        ms =  ms.replace("a",fs);
        ms = ms.replace("b",bs);
        return ms;
    }
    public String SomeFahua(){
        Random rd = new Random();
        String Fahuas = feihua[rd.nextInt(feihua.length)];
        Fahuas = Fahuas.replace("x",theme);
        return Fahuas;
    }
    ...
    public String LastArticle(int number){
        Random rd = new Random();
        String str = "";
...
public class FkArticle {

    public static void main(String[] args) {
        Random rd = new Random();
        FormArticle fa = new FormArticle("我是大傻逼");
        System.out.println(fa.LastArticle(4000));
